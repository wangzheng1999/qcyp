...
<body>
	...
	<script language="JavaScript">
		function t1() {
			var gid = document.goods.getElementById('gid').value;
			var xmlHttp = new ActiveXObject("Msxml2.XMLHTTP");
			var url = "gregister!gid.action?goods.gid=" + gid;
		...
		function t2() {
			var name = document.goods.getElementById('name').value;
			var xmlHttp = new ActiveXObject("Msxml2.XMLHTTP");
			var url = "gregister!name.action?goods.name=" + name;
			xmlHttp.open("post", url, true);
			xmlHttp.onreadystatechange = function() {
				if (xmlHttp.readyState == 4) {
		...
		function t3() {
			...
			var info = document.goods.getElementById('info').value;
			var xmlHttp = new ActiveXObject("Msxml2.XMLHTTP");
			var url = "gregister!info.action?goods.info=" + info;
			xmlHttp.open("post", url, true);
			xmlHttp.onreadystatechange = function() {
				if (xmlHttp.readyState == 4) {
		...
		function t4() {
			...
			var date = document.goods.getElementById('date').value;
			var xmlHttp = new ActiveXObject("Msxml2.XMLHTTP");
			var url = "gregister!date.action?goods.date=" + date;
			xmlHttp.open("post", url, true);
			xmlHttp.onreadystatechange = function() {
				if (xmlHttp.readyState == 4) {
		...
		function t5() {
			...
			var address = document.goods.getElementById('address').value;
			var xmlHttp = new ActiveXObject("Msxml2.XMLHTTP");
			var url = "gregister!address.action?goods.address=" + address;
			xmlHttp.open("post", url, true);
			xmlHttp.onreadystatechange = function() {
				if (xmlHttp.readyState == 4) {
		...
		function t6() {
			...
			var sum = document.goods.getElementById('sum').value;
			var xmlHttp = new ActiveXObject("Msxml2.XMLHTTP");
			var url = "gregister!sum.action?goods.sum=" + sum;
			xmlHttp.open("post", url, true);
			xmlHttp.onreadystatechange = function() {
				if (xmlHttp.readyState == 4) {
		...
		function t7() {
			...
			var price = document.goods.getElementById('price').value;
			var xmlHttp = new ActiveXObject("Msxml2.XMLHTTP");
			var url = "gregister!phone.action?goods.price=" + price;
			xmlHttp.open("post", url, true);
			xmlHttp.onreadystatechange = function() {
				if (xmlHttp.readyState == 4) {
					resultDiv5.innerHTML = xmlHttp.responseText;
