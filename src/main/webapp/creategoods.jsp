			...
			<div class="row">
				...
				<ul id="breadcrumb">
					<ul id="breadcrumb">
						...
						<li><i class="fa fa-lg fa-angle-right"></i></li>
						<li><a href="#" title="Sample page 1">增加商品 </a></li>
					</ul>
				</ul>
								...
								<div class="col-md-9 personal-info">
									...
									<form action="createGoodsAction" class="form-horizontal">
										...
										<div class="form-group">
											...
											<div class="col-lg-8">
												<input id="name" name="goods.name" class="form-control"
													placeholder="请输入商品名称" type="text" onblur="t2()">
										...
										<div class="form-group">
											...
											<div class="col-lg-8">
												<input id="info" name="goods.info" class="form-control"
													placeholder="请输入商品信息" type="text" onblur="t3()">
										...
										<div class="form-group">
											...
											<div class="col-lg-8">
												<input id="date" name="goods.date" class="form-control"
													placeholder="请输入生产日期" type="text" onblur="t4()">
										...
										<div class="form-group">
											...
											<div class="col-lg-8">
												<input id="address" name="goods.address"
													class="form-control" placeholder="请输入产地" type="text"
													onblur="t5()">
										...
										<div class="form-group">
											...
											<div class="col-lg-8">
												<input id="sum" name="goods.sum" class="form-control"
													placeholder="请输入商品总量" type="text" onblur="t6()">
										...
										<div class="form-group">
											...
											<div class="col-lg-8">
												<input id="price" name="goods.price" class="form-control"
													placeholder="请输入商品价格" type="text" onblur="t7()">
										...
										<div style="display: none">
											<input id="flag" name="goods.flag" class="form-control"
												value="1" type="text">
										</div>
										<!-- 	<div class="form-group">
