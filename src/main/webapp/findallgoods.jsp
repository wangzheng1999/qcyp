		...
		<div class="container-fluid paper-wrap bevel tlbr">
			...
			<div class="row">
				...
				<ul id="breadcrumb">
					...
					<li><i class="fa fa-lg fa-angle-right"></i></li>
					<li><a href="#" title="Sample page 1">查看商品</a></li>
										...
										<tbody>
											<s:iterator value="listgoods">
												<tr>
													...
													<td><a
														href="findGoodsByGid?gid=<s:property value="gid"/>"> <s:property
																value="name" /></a></td>
													...
													<td><s:if test="flag==0">
															<span class="status-metro status-suspended"> 缺货中 </span>
														</s:if> <s:else>
															<span class="status-metro status-active"> 热卖中 </span>
														</s:else></td>
													<td><a
														href="upgoods.jsp?gid=<s:property value="gid"/>&&name=<s:property value="name"/>&&info=<s:property value="info"/>&&date=<s:property value="date"/>&&address=<s:property value="address"/>&&sum=<s:property value="sum"/>&&price=<s:property value="price"/>"
														class="btn btn-info">修改商品 </a></td>
												</tr>
											</s:iterator>
										</tbody>
										<tfoot>
